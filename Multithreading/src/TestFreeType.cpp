...
TestFreeType::TestFreeType()
    :m_Text{"Hello World!"}, m_Pos{0.5f, 0.5f, 0.0f, 1.0f}, m_Color{0.5, 0.8f, 0.2f}
{
...
void TestFreeType::attach()
{
    if(!loadFont("/home/jjjurado/Dev/OpenGL/Multithreading/res/fonts/secrcode.ttf"))
    std::cout << "ERROR::TESTFREETYPE: Error loading the font into the Characters Multithreading." << std::endl;
    ...
    m_Shader = std::make_unique<Shader>(Shader::getShaderSource("/home/jjjurado/Dev/OpenGL/Multithreading/res/shaders/FreeType.vs"), 
                    Shader::getShaderSource("/home/jjjurado/Dev/OpenGL/Multithreading/res/shaders/FreeType.fs"));
    
}
void TestFreeType::detach()
{
    glDeleteVertexArrays(1, m_VAO);
	glDeleteBuffers(1, m_VBO);
}

void TestFreeType::update(double ts)
{
