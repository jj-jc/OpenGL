...
int main(void)
{
    ...
    // ------------------------------------------------------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "2.Shaders", NULL, NULL);
    if (!window)
    {
    ...
    Shader ourShader("/home/jjjurado/Dev/OpenGL/3.OpenGlObjects/res/shaders/triangle.vs", "/home/jjjurado/Dev/OpenGL/3.OpenGlObjects/res/shaders/triangle.fs");
