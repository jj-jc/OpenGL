...
int main(void)
{
   ...
   // ------------------------------------------------------------------
   GLFWwindow* window =
      glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Project Structure", NULL, NULL);
   if(!window)
   {
   ...
   Shader myShader(
      Shader::getShaderSource(
         "/home/jjjurado/Dev/OpenGL/Structure/res/shaders/triangle.vs"),
      Shader::getShaderSource(
         "/home/jjjurado/Dev/OpenGL/Structure/res/shaders/triangle.fs"));
   myShader.use();
   // myShader.setUniform4f("u_Color", glm::vec4(0.2627, 0.8706, 0.1098, 1.0));
   // load any kind of image to the GPU
   Texture texture(
      "/home/jjjurado/Dev/OpenGL/Structure/res/textures/Linux.jpeg");
