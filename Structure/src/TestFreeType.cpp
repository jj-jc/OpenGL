...
{
    if(!loadFont("/home/jjjurado/Dev/OpenGL/Structure/res/fonts/secrcode.ttf"))
    ...
    m_Shader = std::make_unique<Shader>(Shader::getShaderSource("/home/jjjurado/Dev/OpenGL/Structure/res/shaders/FreeType.vs"), 
                    Shader::getShaderSource("/home/jjjurado/Dev/OpenGL/Structure/res/shaders/FreeType.fs"));
