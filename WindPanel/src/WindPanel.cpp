...
// WindPanel::getBackgroundVertices(float *vertices)
// {
//     vertices = {
//         this->originX        
//     }
...
WindPanel::WindPanel()
{
    ...
    // m_FontData.init("/home/jjjurado/Dev/OpenGL/WindPanel/res/fonts/FUTRFW.TTF", 120);
    m_FontTitle.init("/home/jjjurado/Dev/OpenGL/WindPanel/res/fonts/secrcode.ttf", 25); // the Size of the font is stored in the oglVisualCommon class
    m_FontData.init("/home/jjjurado/Dev/OpenGL/WindPanel/res/fonts/secrcode.ttf", 40); // the Size of the font is stored in the oglVisualCommon class
...
void WindPanel::update(double ts)
{
    m_Shader->use();
    ...
    freetypeV::print (m_FontTitle, originX + 10, originY - 30, m_recOgl_ptr, L"RWY");
    freetypeV::print (m_FontTitle, originX + width/3 + lineWidht + 10, originY - 30, m_recOgl_ptr, L"Wind Direction");
...
void WindPanel::printHelloWorld()
{
