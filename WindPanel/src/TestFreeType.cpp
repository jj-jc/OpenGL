...
{
    if(!loadFont("/home/jjjurado/Dev/OpenGL/WindPanel/res/fonts/secrcode.ttf"))
    std::cout << "ERROR::TESTFREETYPE: Error loading the font into the Characters WindPanel." << std::endl;
    ...
    m_Shader = std::make_unique<Shader>(Shader::getShaderSource("/home/jjjurado/Dev/OpenGL/WindPanel/res/shaders/FreeType.vs"), 
                    Shader::getShaderSource("/home/jjjurado/Dev/OpenGL/WindPanel/res/shaders/FreeType.fs"));
