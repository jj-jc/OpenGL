...
int main()
{
   ...
   log4cxx::File pc(
      "/home/jjjurado/Dev/OpenGL/WindPanel/conf/log4.cxx.properties");
   ...
   // comsLoop.m_panoramicEntityH_ptr = &windPanel;
   // // windPanel = comsLoop.m_panoramicEntityH;
   // // WindPanel* windPanel_ptr = &comsLoop.m_panoramicEntityH;
   // // windPanel_ptr->printHelloWorld();
   // // ((WindPanel*)(&comsLoop.m_panoramicEntityH))->printHelloWorld();
   // comsLoop.m_panoramicEntityH_ptr->printHelloWorld();

   // comsLoop.m_panoramicEntityH = windPanel;
